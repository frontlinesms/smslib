...
public class ReferenceGsmAlphabet {
	/**
	 * Remapping of Greek characters which are not included in the GSM 7-bit alphabet to characters which are
	 * and which could be interpreted similarly by a Greek reader. 
	 */
